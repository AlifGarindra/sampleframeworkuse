...
@required
- (void)clear __attribute__((swift_name("clear()")));
- (BOOL)getBooleanKey:(NSString *)key __attribute__((swift_name("getBoolean(key:)"))) __attribute__((unavailable("Default values for defaultValue parameters are deprecated")));
...
- (double)getDoubleKey:(NSString *)key __attribute__((swift_name("getDouble(key:)"))) __attribute__((unavailable("Default values for defaultValue parameters are deprecated")));
...
- (float)getFloatKey:(NSString *)key __attribute__((swift_name("getFloat(key:)"))) __attribute__((unavailable("Default values for defaultValue parameters are deprecated")));
...
- (int32_t)getIntKey:(NSString *)key __attribute__((swift_name("getInt(key:)"))) __attribute__((unavailable("Default values for defaultValue parameters are deprecated")));
...
- (int64_t)getLongKey:(NSString *)key __attribute__((swift_name("getLong(key:)"))) __attribute__((unavailable("Default values for defaultValue parameters are deprecated")));
...
- (NSString *)getStringKey:(NSString *)key __attribute__((swift_name("getString(key:)"))) __attribute__((unavailable("Default values for defaultValue parameters are deprecated")));
